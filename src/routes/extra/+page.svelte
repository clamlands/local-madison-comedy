...
<div class="width-container">
  <section>
    ...
    <p>
      ...
      dark, dirty stand-up with her background as a synth producer and academic, Sasha's
      irreverent takes on everything from Pavlov's dog to Sapphic sex are bookended with
      original music made through her side project as exandroid.
    </p>
    <img src={charlie} alt="A Normal Amount of Pain album cover" />
    <h3>A Normal Amount of Pain - Charlie Kojis</h3>
    <p>
      From an antique store in Milwaukee, Wisconsin, comedian Charlie Kojis tells jokes
      about cast iron pans, funerals, and the origins of Irish dance.
    </p>
    <h2>Sketch</h2>
