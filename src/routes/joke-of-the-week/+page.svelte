...
<svelte:head>
  ...
  <meta name="description" content="Submit your jokes for the weekly theme and vote for your favorites!" />
</svelte:head>
  ...
  <section class="joke-of-week-container" data-element="joke-week-section">
    ...
    <div class="theme-container" data-element="theme-container">
      <div class="theme-content" data-element="theme-content">
        ...
        <p class="theme-description" data-element="theme-description">Submit a joke in the above theme and have your jokes featured on the @madisoncomedy Instagram</p>
        
        <div class="theme-example" data-element="theme-example">
          <p data-element="example-intro">This is the joke of the week section for Madison Comedy. Each week, we select a theme, think late night style, punchy stuff. So like if the theme above was "Top Ten Reasons a Dog Should Be Mayor of Madison" you could write "Because traffic on the Isthmus is Ruff"</p>
        </div>
      </div>
    </div>
    ...
    <div class="form-container" data-element="form-container">
      ...
      <p data-element="form-description">Use the form below to submit jokes under this week's theme.</p>
      
      <div class="rules-container" data-element="rules-container">
        <h3 data-element="rules-heading">Rules:</h3>
        <ol data-element="rules-list">
          <li data-element="rule-1">Submit as many jokes as you'd like below. One joke per form submission.</li>
          <li data-element="rule-2">Include your instagram handle if you'd like to be tagged when featured</li>
          <li data-element="rule-3">Anyone can submit, you do not have be a Madison comedian to participate</li>
          <li data-element="rule-4">Join us at the Argus Open Mic Tuesday Nights to hear the best jokes performed live!</li>
        </ol>
      </div>
      
      <div class="google-form-placeholder" data-element="form-placeholder">
        <p data-element="form-placeholder-text">Click the button below to open the submission form</p>
        <a href="{googleFormLink}" class="form-button" data-element="submit-button" target="_blank" rel="noopener noreferrer">Submit Your Joke</a>
      </div>
    </div>
    ...
    <div class="instagram-section" data-element="instagram-section">
      ...
      <p data-element="instagram-description">Follow us on Instagram to see past winners and submissions with #{instagramHashtag}</p>
      <a href="https://www.instagram.com/madisoncomedy" class="instagram-link" data-element="instagram-link" target="_blank" rel="noopener noreferrer">
...
<style>
  ...
  .neon-box {
    ...
    padding: 15px 30px;
    margin: 20px 0;
    box-shadow: 0 0 10px var(--neon2), inset 0 0 10px var(--neon2);
  ...
  .theme-text {
    ...
    font-weight: bold;
    color: white;
    text-shadow: 0 0 5px #fff, 0 0 10px var(--neon2), 0 0 15px var(--neon2);
  }
